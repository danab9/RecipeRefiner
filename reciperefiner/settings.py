"""
Django settings for reciperefiner project.
...
ROOT_URLCONF = "reciperefiner.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [BASE_DIR / "frontend" / "dist"],  # so Django can serve the built Vue index.html
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "reciperefiner.wsgi.application"
...
DATABASES = {
    "default": dj_database_url.config(
        ...
        conn_max_age=600,
        ssl_require=False,   # Neon's URL already carries sslmode=require
    )
}
...
STATICFILES_DIRS = [BASE_DIR / "frontend" / "dist"]  # the built Vue assets
STORAGES = {
