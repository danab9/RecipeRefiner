      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`h-11 w-full rounded-control border bg-surface text-content placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent ${
              icon ? 'pl-10' : 'pl-3'
            } ${trailing ? 'pr-10' : 'pr-3'} ${
