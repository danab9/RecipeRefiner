...
describe('MainNav', () => {
  it('shows a login link and no logout button when logged out', () => {
    mockedUseMe.mockReturnValue({ data: null, isPending: false } as ReturnType<typeof useMe>)
    mockedUseHistory.mockReturnValue({ data: undefined } as ReturnType<typeof useHistory>)
  ...
  it('shows the greeting, history link, and saved-count badge when logged in', () => {
    ...
    mockedUseMe.mockReturnValue({ data: user, isPending: false } as ReturnType<typeof useMe>)
